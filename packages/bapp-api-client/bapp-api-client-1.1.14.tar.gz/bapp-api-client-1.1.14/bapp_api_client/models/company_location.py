...
class CompanyLocation(object):
    ...
    def __init__(self, id=None, name=None, vat_id=None, country=None, region=None, city=None, address=None, former_location_id=None, _configuration=None):  # noqa: E501
        ...
        if former_location_id is not None:
            self.former_location_id = former_location_id
    ...
    @property
    def former_location_id(self):
        """Gets the former_location_id of this CompanyLocation.  # noqa: E501


        :return: The former_location_id of this CompanyLocation.  # noqa: E501
        :rtype: int
        """
        return self._former_location_id

    @former_location_id.setter
    def former_location_id(self, former_location_id):
        """Sets the former_location_id of this CompanyLocation.


        :param former_location_id: The former_location_id of this CompanyLocation.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                former_location_id is not None and former_location_id > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `former_location_id`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                former_location_id is not None and former_location_id < 0):  # noqa: E501
            raise ValueError("Invalid value for `former_location_id`, must be a value greater than or equal to `0`")  # noqa: E501

        self._former_location_id = former_location_id
