...
class Revision(object):
    ...
    def __init__(self, id=None, document=None, edition=None, version=None, file=None, date_start=None, date_stop=None, message=None, acceptance_data=None, employees=None, is_active=None, _configuration=None):  # noqa: E501
