...
class ProductCategory(object):
    ...
    def __init__(self, id=None, name=None, parent=None, former_category_id=None, description=None, active=None, translations=None, photo=None, markup=None, _configuration=None):  # noqa: E501
