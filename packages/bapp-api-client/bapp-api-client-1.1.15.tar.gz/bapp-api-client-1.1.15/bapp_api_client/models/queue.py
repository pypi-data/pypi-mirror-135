...
class Queue(object):
    ...
    def __init__(self, id=None, parent=None, name=None, description=None, escalate_days=None, default_owners=None, department=None, identifier=None, allow_public_submission=None, new_ticket_cc=None, updated_ticket_cc=None, project=None, service=None, partner=None, _configuration=None):  # noqa: E501
