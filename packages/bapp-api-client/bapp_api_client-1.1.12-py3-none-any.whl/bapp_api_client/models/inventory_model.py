...
class InventoryModel(object):
    ...
    def __init__(self, id=None, stock=None, administrator=None, series=None, location=None, number=None, _date=None, status=None, accounting=None, inventory=None, difference=None, depreciation=None, view_tokens=None, _configuration=None):  # noqa: E501
