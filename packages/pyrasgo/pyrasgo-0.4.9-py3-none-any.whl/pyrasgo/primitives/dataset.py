...
# --------
    ...
    def to_df(
        ...
        You can supply WHERE clause filters, order the dataset by columns, only
        ...
        Args:
            ...
            limit: Only return this main rows in the df
        """
    ...
    def preview(
        ...
        You can supply WHERE clause filters, order the dataset by columns, and
