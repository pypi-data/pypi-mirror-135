...
#pass the arguments from commline line
    ...
    parser.add_argument('-mkdup', action ='store_const', const = True,
                    default = True, dest ='mkdup', 
                    help ="mark the duplications during alignment, default=True")
    ...
    if args.alignment:
        alignment(fq1 = args.fq1, fq2 = args.fq2, humRef = args.humRef, virRef = args.virRef, index = args.index, mkdup = args.mkdup, outputDir = args.outputDir, gz = args.gz)
