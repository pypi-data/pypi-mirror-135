...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, proxy_password=None, ca_cert=None, client_key=None, name=None, max_retries=None, rate_limit=None, headers=None, username=None, total_timeout=None, sock_connect_timeout=None, client_cert=None, proxy_url=None, connect_timeout=None, pulp_labels=None, password=None, download_concurrency=None, url=None, tls_validation=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
