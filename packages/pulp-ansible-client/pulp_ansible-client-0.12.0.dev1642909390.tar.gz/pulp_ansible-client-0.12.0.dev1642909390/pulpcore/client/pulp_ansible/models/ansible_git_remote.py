...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, sock_connect_timeout=None, pulp_labels=None, ca_cert=None, rate_limit=None, sock_read_timeout=None, connect_timeout=None, headers=None, username=None, proxy_url=None, download_concurrency=None, client_cert=None, client_key=None, proxy_username=None, total_timeout=None, tls_validation=None, max_retries=None, password=None, name=None, proxy_password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
