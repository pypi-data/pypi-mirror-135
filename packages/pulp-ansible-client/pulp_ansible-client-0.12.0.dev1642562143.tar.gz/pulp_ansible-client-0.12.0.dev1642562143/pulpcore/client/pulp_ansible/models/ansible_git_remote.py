...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, sock_read_timeout=None, tls_validation=None, proxy_username=None, pulp_labels=None, total_timeout=None, client_cert=None, proxy_url=None, download_concurrency=None, connect_timeout=None, sock_connect_timeout=None, password=None, client_key=None, ca_cert=None, username=None, max_retries=None, headers=None, proxy_password=None, url=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
