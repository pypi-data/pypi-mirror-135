...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, sock_read_timeout=None, pulp_href=None, tls_validation=None, pulp_labels=None, total_timeout=None, client_cert=None, proxy_url=None, pulp_created=None, download_concurrency=None, connect_timeout=None, sock_connect_timeout=None, ca_cert=None, max_retries=None, headers=None, pulp_last_updated=None, url=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
