...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, sock_connect_timeout=None, pulp_href=None, pulp_last_updated=None, pulp_labels=None, ca_cert=None, rate_limit=None, sock_read_timeout=None, connect_timeout=None, headers=None, proxy_url=None, download_concurrency=None, client_cert=None, total_timeout=None, pulp_created=None, tls_validation=None, max_retries=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
