...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, tls_validation=None, max_retries=None, total_timeout=None, headers=None, pulp_href=None, client_cert=None, download_concurrency=None, proxy_url=None, pulp_labels=None, ca_cert=None, sock_connect_timeout=None, rate_limit=None, pulp_last_updated=None, pulp_created=None, name=None, connect_timeout=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
