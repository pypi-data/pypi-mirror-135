...
class AnsibleGitRemote(object):
    ...
    def __init__(self, url=None, tls_validation=None, max_retries=None, proxy_username=None, username=None, total_timeout=None, headers=None, client_key=None, client_cert=None, download_concurrency=None, proxy_url=None, pulp_labels=None, ca_cert=None, sock_connect_timeout=None, rate_limit=None, proxy_password=None, name=None, connect_timeout=None, password=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
