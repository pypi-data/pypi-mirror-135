...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, password=None, ca_cert=None, total_timeout=None, proxy_url=None, sock_read_timeout=None, name=None, sock_connect_timeout=None, proxy_username=None, pulp_labels=None, download_concurrency=None, username=None, headers=None, connect_timeout=None, client_cert=None, rate_limit=None, max_retries=None, tls_validation=None, url=None, client_key=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
