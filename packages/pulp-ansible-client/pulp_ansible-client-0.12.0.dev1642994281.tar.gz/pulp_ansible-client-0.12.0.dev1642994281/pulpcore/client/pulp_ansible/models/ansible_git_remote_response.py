...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, ca_cert=None, total_timeout=None, proxy_url=None, sock_read_timeout=None, name=None, sock_connect_timeout=None, pulp_created=None, pulp_labels=None, download_concurrency=None, headers=None, connect_timeout=None, client_cert=None, rate_limit=None, max_retries=None, pulp_href=None, pulp_last_updated=None, tls_validation=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
