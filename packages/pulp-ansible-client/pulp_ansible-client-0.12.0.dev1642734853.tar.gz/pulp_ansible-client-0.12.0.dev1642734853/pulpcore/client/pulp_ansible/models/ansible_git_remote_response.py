...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, ca_cert=None, name=None, pulp_href=None, max_retries=None, rate_limit=None, headers=None, total_timeout=None, sock_connect_timeout=None, client_cert=None, proxy_url=None, pulp_created=None, connect_timeout=None, pulp_labels=None, download_concurrency=None, url=None, tls_validation=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
