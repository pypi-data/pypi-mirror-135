...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, ca_cert=None, rate_limit=None, max_retries=None, download_concurrency=None, password=None, username=None, headers=None, tls_validation=None, sock_connect_timeout=None, connect_timeout=None, client_key=None, proxy_password=None, name=None, client_cert=None, total_timeout=None, proxy_username=None, sock_read_timeout=None, proxy_url=None, pulp_labels=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
