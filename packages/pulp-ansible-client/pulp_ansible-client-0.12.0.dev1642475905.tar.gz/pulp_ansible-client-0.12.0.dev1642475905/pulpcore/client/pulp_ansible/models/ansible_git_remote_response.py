...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, tls_validation=None, ca_cert=None, pulp_labels=None, rate_limit=None, proxy_url=None, total_timeout=None, client_cert=None, sock_connect_timeout=None, pulp_href=None, pulp_created=None, sock_read_timeout=None, pulp_last_updated=None, name=None, url=None, connect_timeout=None, max_retries=None, download_concurrency=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
