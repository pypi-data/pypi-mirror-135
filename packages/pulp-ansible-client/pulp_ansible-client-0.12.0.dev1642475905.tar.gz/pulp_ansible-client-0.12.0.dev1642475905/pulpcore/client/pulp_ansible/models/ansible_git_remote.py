...
class AnsibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, ca_cert=None, proxy_username=None, pulp_labels=None, rate_limit=None, proxy_url=None, total_timeout=None, proxy_password=None, client_cert=None, sock_connect_timeout=None, password=None, client_key=None, sock_read_timeout=None, name=None, url=None, username=None, connect_timeout=None, max_retries=None, download_concurrency=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
