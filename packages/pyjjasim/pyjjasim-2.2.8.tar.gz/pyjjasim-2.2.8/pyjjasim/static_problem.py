...
class ParameterOptimizeInfo:
    ...
    def _set(self, lambda_value, solution, lambda_stepsize, found_solution, newton_iter_info, is_stable=False):
...
class StaticConfiguration:
    ...
    def plot(self, node_quantity=None, junction_quantity="I", face_quantity=None,
        ...
        self.plot_handle = ConfigPlot(self, vortex_quantity=vortex_quantity,
            ...
            figsize=figsize, title=title, fig=fig).make()
...
def compute_maximal_parameter(problem_function, initial_guess=None, lambda_tol=DEF_MAX_PAR_TOL,
    ...
    out = cur_problem.compute(initial_guess=theta0, tol=newton_tol, maxiter=newton_maxiter,
    ...
    while True:
        ...
        info._set(lambda_val, config if has_converged else None, lambda_stepsize,
                  has_converged, newton_iter_info, is_stable)
