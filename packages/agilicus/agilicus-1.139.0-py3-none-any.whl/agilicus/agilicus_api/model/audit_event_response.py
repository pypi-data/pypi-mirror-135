"""
    ...
    The version of the OpenAPI document: 2022.01.19
...
class AuditEventResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, unique_id, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status_message (bool, date, datetime, dict, float, int, list, str, none_type): An optional message describing what happened with the event. . [optional]  # noqa: E501
