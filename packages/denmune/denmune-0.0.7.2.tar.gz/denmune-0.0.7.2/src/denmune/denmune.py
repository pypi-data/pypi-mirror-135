    ...
    def fit_predict(self,
        ...
        if validate and self.data_indicator >= 1: 
           ...
           if self.data_indicator == 15:
               ...
               if show_analyzer:
                   show_analyzer(self.analyzer['validity']['augmented'], root='Validating augmented data (train & test)')
