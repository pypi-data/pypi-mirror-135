...
class itkForward1DFFTImageFilterID2(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2ICD2):
    ...
    Forward1DFFTImageFilter implements methods for generating output
    information and relies on the ITK object factory to select a viable
    backend to generate data. Forward1DFFTImageFilter does not itself
    implement FFT.

    See:  itkVnlForward1DFFTImageFilter

    See:  itkFFTWForward1DFFTImageFilter 
    """
