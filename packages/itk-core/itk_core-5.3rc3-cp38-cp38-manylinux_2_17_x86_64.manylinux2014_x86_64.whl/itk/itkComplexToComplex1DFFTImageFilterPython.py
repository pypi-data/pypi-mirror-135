...
class itkComplexToComplex1DFFTImageFilterICD2(itk.itkImageToImageFilterBPython.itkImageToImageFilterICD2ICD2):
    ...
    Perform the Fast Fourier Transform, complex input to complex output,
    but only along one dimension.

    The direction of the transform, 'Forward' or 'Inverse', can be set
    with SetTransformDirection() and GetTransformDirection().
