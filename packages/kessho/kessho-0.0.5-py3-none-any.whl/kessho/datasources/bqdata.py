...
class BQChartData:
    ...
    Preconditions:
        ...
        - If there's no table yet, you can create one from appropriately structured CSV files in a given bucket using load_from_bucket()
        - The BigQuery table used for querying eventually has the desired schema:
