                ...
                $(config.deviceDialog).dialog({
                    ...
                    buttons: {
                        'Save Changes': function() {
                            if (!validateIPaddress($('#ys-base-address').val())){
                                return
                            }
                            else {
                              updateDevice(
...
function validateIPaddress(input_ip_t)
   {
     let input_ip=input_ip_t
     let ipformat4 = /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/;
     ...
     if(!(input_ip.match(ipformat4) || input_ip.match(ipformat6)) && (input_ip.length != 0))
     {
