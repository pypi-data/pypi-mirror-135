...
namespace __pythran__rbfinterp_pythran
{
  ...
  {
    {
      long  __target140098694757968 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, x));
      for (long  i=0L; i < __target140098694757968; i += 1L)
      {
        {
          long  __target140098694328432 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, powers));
          for (long  j=0L; j < __target140098694328432; j += 1L)
          {
  ...
  {
    {
      long  __target140098694755520 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, x));
      for (long  i=0L; i < __target140098694755520; i += 1L)
      {
        {
          long  __target140098694758112 = pythonic::operator_::add(i, 1L);
          for (long  j=0L; j < __target140098694758112; j += 1L)
          {
  ...
  {
    {
      long  __target140098694882352 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, powers));
      for (long  i=0L; i < __target140098694882352; i += 1L)
      {
  ...
  {
    {
      long  __target140098694739616 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, y));
      for (long  i=0L; i < __target140098694739616; i += 1L)
      {
  ...
  typename _evaluate::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4, argument_type5, argument_type6, argument_type7>::result_type _evaluate::operator()(argument_type0&& x, argument_type1&& y, argument_type2&& kernel, argument_type3&& epsilon, argument_type4&& powers, argument_type5&& shift, argument_type6&& scale, argument_type7&& coeffs) const
  {
    ...
    {
      long  __target140098693934576 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, x));
      for (long  i=0L; i < __target140098693934576; i += 1L)
      {
        ...
        {
          long  __target140098693949856 = std::get<1>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, coeffs));
          for (long  j=0L; j < __target140098693949856; j += 1L)
          {
            {
              long  __target140098693968608 = pythonic::operator_::add(p, std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, powers)));
              for (long  k=0L; k < __target140098693968608; k += 1L)
              {
  ...
  typename _build_system::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4, argument_type5>::result_type _build_system::operator()(argument_type0&& y, argument_type1&& d, argument_type2&& smoothing, argument_type3&& kernel, argument_type4&& epsilon, argument_type5&& powers) const
  {
    ...
    {
      long  __target140098694414448 = p;
      for (long  i=0L; i < __target140098694414448; i += 1L)
      {
