...
namespace __pythran__spectral
{
  ...
  typename _lombscargle::type<argument_type0, argument_type1, argument_type2>::result_type _lombscargle::operator()(argument_type0&& x, argument_type1&& y, argument_type2&& freqs) const
  {
    ...
    {
      long  __target140098689262928 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, freqs));
      for (long  i=0L; i < __target140098689262928; i += 1L)
      {
        ...
        {
          long  __target140098692145104 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, x));
          for (long  j=0L; j < __target140098692145104; j += 1L)
          {
