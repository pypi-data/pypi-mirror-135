...
inline
bool
gmm_full<eT>::km_iterate(const Mat<eT>& X, const uword maxIter, const bool verbose)
  {
  arma_extra_debug_sigprint();
...
inline
bool
gmm_full<eT>::em_iterate(const Mat<eT>& X, const uword maxIter, const eT var_floor, const bool verbose)
  {
  arma_extra_debug_sigprint();
