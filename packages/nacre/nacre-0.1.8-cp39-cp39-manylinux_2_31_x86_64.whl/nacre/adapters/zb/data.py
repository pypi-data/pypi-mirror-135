...
class ZbDataClient(LiveMarketDataClient):
    """
    Provides a data client for the Zb exchange.
    """
    ...
    def __init__(
        ...
        ws_api: ZbWebSocketClient,
        instrument_provider: ZbInstrumentProvider,
    ):
        """
        Initialize a new instance of the ``ZbDataClient`` class.
