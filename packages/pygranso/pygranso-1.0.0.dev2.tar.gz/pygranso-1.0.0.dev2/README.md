...
3. Install from PyPI: 
    ...
    OS: Linux; Compute Platform: CPU:
        ...
        pip install requirements_linux_cpu.txt -f https://download.pytorch.org/whl/cpu/torch_stable.html

    OS: Mac; Compute Platform: CPU:

        pip install requirements_mac_cpu.txt
    
    OS: Windows; Compute Platform: CUDA:

        pip install requirements_win_cuda.txt

    OS: Windows; Compute Platform: CPU:

        pip install requirements_win_cpu.txt
