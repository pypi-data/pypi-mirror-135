...
def _from_JulianTAI(d1, d2, out_array, f_res, r_res):
    return _core._from_JulianTAI(d1, d2, out_array, f_res, r_res)

def _to_JulianTAI(indices, d1, d2):
    return _core._to_JulianTAI(indices, d1, d2)

def _from_JulianUTC(d1, d2, out_array, f_res, r_res):
    return _core._from_JulianUTC(d1, d2, out_array, f_res, r_res)

def _to_JulianUTC(indices, d1, d2):
    return _core._to_JulianUTC(indices, d1, d2)
