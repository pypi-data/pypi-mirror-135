...
def test__mean_absolute_scaled_error__raise_when_y_true_has_different_size_than_y_pred():
    ...
    assert str(e.value) == "The provided inputs must contain the same number of elements: y_true and y_pred."
...
def test__mean_absolute_scaled_error__raise_when_y_true_has_less_than_two_values():
    ...
    assert str(e.value) == "The provided inputs must contain at least 2 elements: y_true and y_pred."
...
def test__mase_by_series__raises_when_dimension_not_same_size_as_y_true():
    ...
    assert str(e.value) == "The provided inputs must contain the same number of elements: y_true, y_pred, dimension and time."
