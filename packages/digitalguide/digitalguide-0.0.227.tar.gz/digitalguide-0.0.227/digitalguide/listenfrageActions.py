...
def telegram_loop_list(update: Update, context: CallbackContext, key, value, doppelte_antwort, answer_id_list, fertig_antwort):
    ...
    print("Context: {}".format(set(context.user_data[key])))
    print("lListe: {}".format(answer_id_list))
