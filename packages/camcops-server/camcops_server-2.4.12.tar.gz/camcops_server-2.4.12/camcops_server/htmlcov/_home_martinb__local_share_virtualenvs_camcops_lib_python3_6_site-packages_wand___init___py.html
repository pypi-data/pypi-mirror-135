...
<head>
    ...
    <title>Coverage for /home/martinb/.local/share/virtualenvs/camcops/lib/python3.6/site-packages/wand/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/martinb/.local/share/virtualenvs/camcops/lib/python3.6/site-packages/wand/__init__.py</b> :
...
<div id="source">
    <p id="t1" class="pln"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="str">""":mod:`wand` --- Simple `MagickWand API`_ binding for Python</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t4" class="pln"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="str">.. _MagickWand API: http://www.imagemagick.org/script/magick-wand.php</span>&nbsp;</span><span class="r"></span></p>
