...
class BertSTEMForTextClassification:
    ...
    def _train(self, inputs_train, inputs_val, num_train_epochs=3, learning_rate=1e-5,
               load_best_model_at_end=True, early_stopping_patience=5, metric_for_best_model="bacc"):
