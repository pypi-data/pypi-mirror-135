...
class ResourceStage:
    ...
    def run(self, output_path: str, start_block: int):
        ...
        ResourceStage.do_filtrate(output_path, filtrate_output_path, self.exclude_columns, self.bytea_columns)
    ...
    @staticmethod
    def do_filtrate(output_path: str, filtrated_output_path: str, exclude_columns: [int], bytea_columns: [int]):
