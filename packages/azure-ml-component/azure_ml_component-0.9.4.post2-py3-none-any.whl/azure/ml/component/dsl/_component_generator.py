        ...
        for pattern, definition_list in definitions.items():
            for definition in definition_list:
                ...
                try:
                    ...
                    logger.warning(f'Skip {definition.name!r} for generate component failed with {ex!r}.')
...
class ModulePackageGenerator:
    ...
    def _remove_dup_definition(definitions, component_names, is_local=False, key_pattern=None):
        ...
        for definition in definitions:
            ...
            if name in component_names:
                ...
                logger.warning(f'Skip {source!r} for duplicate component name {name!r} found.')
                continue
    ...
    def generate(self):
        ...
        # TODO: For external call tasks, change to parallel tasks.
        ...
        if len(list(itertools.chain(*self._download_snapshots.values()))):
            ...
            logger.info(f"Finished create snapshots in {timer_context.get_duration_seconds()} seconds.")
...
class GraphComponentSnapshotGenerator(ModulePackageGenerator):
    ...
    def _resolve_assets_in_file(self, assets_dict, module):
        components = ComponentAPI(workspace=self._workspace, logger=_get_logger()).batch_get(
