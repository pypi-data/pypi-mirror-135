...
def _prepare_component_snapshot(component, target_dir):
    ...
    # When target is None, get_snapshot will generate a temp dir.
    snapshot_local_cache = component._definition.get_snapshot(target=None)
    shutil.copytree(snapshot_local_cache, target_dir)
