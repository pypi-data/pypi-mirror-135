...
setuptools.setup(
    name="SIMULTAN_MeshTools",
    version="0.7",
    description="Create meshes and map values on meshes for SIMULTAN geometry",
    ...
    entry_points={"console_scripts": ["simultan_mesh_tools=SIMULTAN_MeshTools.gui.pyside6.gui:main"]},
)
