...
package_name = 'qahal'
version = '1.0.0'
keywords = 'state machine menu'
requirements = []
short_description = 'State machine with variables within states.'
long_description = ''':Date: 2022-01-24
:Version: 1.0.0
:Authors:
...
setup(
    ...
    url=f'https://github.com/alghafli/{package_name}',  # Optional
