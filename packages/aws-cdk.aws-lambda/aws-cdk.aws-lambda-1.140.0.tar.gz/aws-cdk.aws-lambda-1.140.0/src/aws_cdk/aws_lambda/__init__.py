...
class CfnEventSourceMapping(
    ...
    def __init__(
        ...
        *,
        ...
        :param maximum_batching_window_in_seconds: (Streams and Amazon SQS standard queues) The maximum amount of time, in seconds, that Lambda spends gathering records before invoking the function. Default: 0
