...
def process_casino(item, actors={}):
    _doc = item['_source']
    _doc['id'] = item['_id']
    # _doc['publishedon'] = f"{_doc['publishedon']}Z"
    # _doc['updatedon'] = f"{_doc['updatedon']}Z"
...
class ApiAdminUsers(Resource):
    ...
    def post(self):
        ...
        def process_user(item):
            _doc = item['_source']
            # _doc['last_auth'] = f"{_doc['last_auth']}Z"
            # _doc['sign_date'] = f"{_doc['sign_date']}Z"
            return _doc
...
class ApiContentTickets(Resource):
    ...
    def post(self):
        ...
        def process_ticket(_doc, _id):
            ...
            _doc['id'] = _id      
            # _doc['createdon'] = f"{_doc['createdon']}Z"
            return _doc
