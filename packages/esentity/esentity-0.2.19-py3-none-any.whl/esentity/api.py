...
from esentity.models import AuthModel, SignupModel, UserModel, ManagerModel, CasinoModel, CasinoProxyModel, DomainModel, CampaignModel  
        ...
        try:
            ...
            try:
                ...
                if found == 0:
                    ...
                    if obj.invite_code and len(obj.invite_code) == 56:
