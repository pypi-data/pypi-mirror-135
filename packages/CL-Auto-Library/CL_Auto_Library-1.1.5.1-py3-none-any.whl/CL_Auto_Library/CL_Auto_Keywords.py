...
def read_outlook_email(username, find_what, mailbox_folder, sender_email_address, email_subject, start_hours, end_hours):
    ...
    for msg in list(messages):
		...
		for count < 15:
			...
			if username in msg.Body:
			    find_what = find_what.lower()
				if find_what = "password":
