 ...
 *     return (hh << 32) | hl
 */
  __pyx_v_hh = __pyx_f_5rbfly_6_codec_unpack_uint32(__pyx_v_data);
 ...
 * 
 */
  __pyx_v_hl = __pyx_f_5rbfly_6_codec_unpack_uint32((&(__pyx_v_data[4])));
 ...
 * 
 */
  (((uint32_t *)__pyx_v_data)[0]) = htonl(((uint32_t)(__pyx_v_value >> 32)));
 ...
 * # vim: sw=4:et:ai
 */
  (((uint32_t *)(&(__pyx_v_data[4])))[0]) = htonl(((uint32_t)__pyx_v_value));
