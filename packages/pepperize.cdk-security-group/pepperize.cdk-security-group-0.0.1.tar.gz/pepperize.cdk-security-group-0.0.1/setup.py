    ...
    """
{
    ...
    "version": "0.0.1",
    "description": "This project provides a CDK construct for creating a security group with an extractable securityGroupName.",
    "license": "MIT",
    ...
    "package_data": {
        "pepperize_cdk_security_group._jsii": [
            "cdk-security-group@0.0.1.jsii.tgz"
        ],
        "pepperize_cdk_security_group": [
            "py.typed"
        ]
