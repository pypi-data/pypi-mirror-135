...
class TestGnmiTestShim(unittest.TestCase):
    ...
    def test_set_api(self):
        ...
        self.assertEqual(jdict, json_decoded)
        self.assertEqual(val['jsonIetfVal'], json_val_decoded)
    ...
    def test_get_api(self):
        ...
        self.assertEqual(jdict2, dictfrom2)

    def test_subscibe_api(self):
        """Verify a subscribe request is correct through susscribe API."""
        r3 = deepcopy(request3)
        r3['sample_interval'] = 20
        resp = gnmi.subscribe_request('test', self.devprofile, r3)
        jdict3 = json.loads(resp)
        self.assertEqual(jdict3, subscribe_dict)
