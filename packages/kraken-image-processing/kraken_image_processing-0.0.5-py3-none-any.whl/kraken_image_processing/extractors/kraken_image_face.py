...
embedder = cv2.dnn.readNetFromTorch('kraken_image_processing/models/nn4.small2.v1.t7')
...
def get_faces(record):
    ...
    # Load the cascade
    face_cascade = cv2.CascadeClassifier('kraken_image_processing/models/haarcascade_frontalface_default.xml')
