...
class SaveMeasuresTest(unittest.TestCase):
    ...
    def test_saveMeasures(self):
        sensor_service = mock()
        measures = [
            MeasureData(87, date_time('2021-12-20 16:49:59'), 5.9, 62),
            MeasureData(87, date_time('2021-12-20 16:50:00'), 6.0, 63),
            MeasureData(87, date_time('2021-12-20 16:50:01'), 6.1, 64),
            MeasureData(56, date_time('2021-12-20 16:51:01'), 3.1, 62),
        ]
