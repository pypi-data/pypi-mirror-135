...
class MeasureRepository:
    ...
    def get_measures_after(self, sensor_name: str, last: str) -> List[MeasureData]:
    ...
    def save(self, measure: MeasureData) -> bool:
    ...
    def __need_to_persist(self, last_measure: datetime, new_measure: MeasureData) -> bool:
        return new_measure.measured_at >= (last_measure + + timedelta(minutes=1))
    ...
    def __get_conf_name(self, sensor_id: int) -> str | None:
