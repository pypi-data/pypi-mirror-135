...
class MeasureRepositoryShould(unittest.TestCase):
    ...
    def test_save(self):
        ...
        result = repo.save(MeasureData(1, date_time('2022-01-18 11:59:59'), 0, 0))
        self.assertEqual(False, result, msg='Measure before last measurement')

        result = repo.save(MeasureData(1, date_time('2022-01-18 12:00:59'), 0, 0))
        self.assertEqual(False, result, msg='Measure too short after last measurement')

        result = repo.save(MeasureData(1, date_time('2022-01-18 12:01:00'), 0, 0))
