...
class BaseNavigation(_Backbone):
    ...
    def add_about(self,
        ...
        bus_cf.add(bus_frm, title="About", style='secondary.TButton')
        ...
        if github_url:
            ...
            github_label = ttk.Label(bus_frm, text=f"> GitHub", style="info.TLabel", justify="left")
...
class BaseNoteBook(_Backbone):
    ...
    def build(self, master, global_info):
        ...
        self.text_area.insert("end", "Link to console: success.\n")
