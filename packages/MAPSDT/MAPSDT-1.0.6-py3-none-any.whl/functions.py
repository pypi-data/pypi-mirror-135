...
def processContinuousFeatures(data, attribute, entropy, depth, max_depth):
    ...
    for i in range(0, len(unique_values) - 1):
        ...
        if (max_depth - depth) <= -1:
            ...
            threshold_splitinfo = math.log(len(subset1), 2) - subset1_probability * math.log(
                len(subset1) * subset1_probability, 2) + math.log(len(subset2), 2) - subset2_probability * math.log(
                len(subset2) * subset2_probability, 2)
