...
def get(isPollinationModel: bool = False, 
    ...
    syncToken: str
        A string that enable the auto-refresh of the component. Allowed prefixes
        are 'PollinationModel' or 'GeometryModel'
        Example of token:
        - PollinationModelfeb03dd8-1f68-44eb-884b-9e4d80a4816e
        - GeometryModelfeb03dd8-1f68-44eb-884b-9e4d80a4816e
        
        It can also be the output of the special.sync component or a common streamlit 
        component with one of the prefix above (e.g. a number slider output).   
    key: str or None
        An optional key that uniquely identifies this component. If this is
        None, and the component's arguments are changed, the component will
        be re-mounted in the Streamlit frontend and lose its current state.
