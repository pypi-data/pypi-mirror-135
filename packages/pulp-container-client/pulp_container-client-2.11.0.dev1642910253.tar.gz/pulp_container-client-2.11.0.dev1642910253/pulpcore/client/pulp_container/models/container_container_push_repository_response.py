...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, retain_repo_versions=None, versions_href=None, name=None, pulp_created=None, pulp_labels=None, description=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
