...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, versions_href=None, name=None, description=None, retain_repo_versions=None, latest_version_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
