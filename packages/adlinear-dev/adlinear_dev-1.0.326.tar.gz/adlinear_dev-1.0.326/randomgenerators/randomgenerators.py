...
def generate_nmf_reconstruction(n_comp: int, n_feat: int, n_obs: int, h_icorr_min: float, h_icorr_max: float,
                                w_icorr_min=0.0, epsilon: float = 0.10, random_norms: bool = True,
                                wclust_factor: float = 1.0, w_icorr_max=0.3) -> Tuple[pd.DataFrame]:

    n_clust_h = n_comp
    n_clust_w = max(1, int(n_clust_h * wclust_factor))
    ...
    cl_vects_h = utl.generate_clusterized_vectors(veclen=n_comp,
                                                  ...
                                                  max_inter_corr=h_icorr_max,
                                                  min_intra_corr=h_icorr_min,
    ...
    cl_vects_w = utl.generate_clusterized_vectors(veclen=n_comp,
                                                  ...
                                                  max_inter_corr=w_icorr_max,
                                                  min_intra_corr=w_icorr_min,
                                                  random_norms=random_norms)
