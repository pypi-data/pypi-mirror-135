...
from foreverbull_core.models.finance import Asset, EndOfDay, Portfolio
...
class Feed:
    ...
    def _send_stock_data(self, asset, data):
        ...
        eod = EndOfDay(
            asset=a,
            date=get_datetime().to_pydatetime(),
            price=data.current(asset, "price"),
            last_traded=data.current(asset, "last_traded").to_pydatetime(),
        ...
        req = Request(task="stock_data", data=eod.dict())
        self.socket.send(req.dump())
