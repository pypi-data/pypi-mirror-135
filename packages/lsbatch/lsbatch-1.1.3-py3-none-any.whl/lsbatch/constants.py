...
API_BASE_URL = {
    ...
    "31" : "https://batchjob-api-ir31.leadsquared.com/api/developersdk"
}
...
class Messages:
    ...
    RegionArgumentHelp = 'valid values for region are MUM,SGP,US,IR,21,1,11,31'
...
class ValidationMessages:
    ...
    InvalidValueOfRegion = 'Invalid value provided for region, valid values for region are MUM,SGP,US,IR,21,1,11,31'
