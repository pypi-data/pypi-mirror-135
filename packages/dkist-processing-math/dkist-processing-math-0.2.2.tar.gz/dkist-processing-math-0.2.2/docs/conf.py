...
doc_requires = get_distribution("dkist_processing_math").requires(extras=("docs",))
...
# -- Non stdlib imports --------------------------------------------------------
import dkist_processing_math  # NOQA
from dkist_processing_math import __version__  # NOQA
...
autoapi_dirs = ["../dkist_processing_math"]
...
intersphinx_mapping = {
    ...
    # dkist_processing_math depends only on dkist_processing_common for internal cross references
