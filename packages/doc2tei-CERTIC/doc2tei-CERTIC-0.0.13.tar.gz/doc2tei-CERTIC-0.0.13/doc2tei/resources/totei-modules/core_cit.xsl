...
<xsl:template match="text:p[@text:style-name='adcitationrom']">
    <cit>
        <quote>
            <xsl:apply-templates/>
        </quote>
...
<xsl:template match="text:p[@text:style-name='adcitationital']">
    <cit>
<!--   xml:lang="##"     -->
        <quote>
            <xsl:apply-templates/>
...
<xsl:template match="text:span[@text:style-name='adCAcitation']">
    <cit>
        <quote>
            <xsl:apply-templates/>
        </quote>
