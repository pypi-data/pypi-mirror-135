...
class Automation():
    ...
    def workflowInstances(self, workflowId:str=None, fromTimepoint:str=None, toTimepoint:str=None, showTasks=False) -> pd.DataFrame:
        ...
        graphQLString = f'''query Instances {{
            {key}({_workflowId}, {_fromTimepoint}, {_toTimepoint}, all:true) {{
                id
                name
                businessKey
                version
