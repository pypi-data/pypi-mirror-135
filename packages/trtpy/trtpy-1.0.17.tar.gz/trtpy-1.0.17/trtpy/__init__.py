...
lean_metas = [
    {
        ...
        "binary_url_linux": f"{lean_url}/nvbin/v1.0/trt8cuda102cudnn8.zip",
        ...
        "pycs": [
            {
                ...
                "binary_url_linux": f"{lean_url}/{version}/py37-trt8-cuda10.2-cudnn8/libtrtpyc.so",
                "tensorrt_url_linux": f"{lean_url}/{version}/py37-trt8-cuda10.2-cudnn8/tensorrt.so",
                "binary_url_windows": None,
                "tensorrt_url_windows": None
            },
            {
                "name": "py38trt8cuda102cudnn8",
                "python": "3.8",
                "lean": "trt8cuda102cudnn8",
                "binary_url_linux": f"{lean_url}/{version}/py38-trt8-cuda10.2-cudnn8/libtrtpyc.so",
                "tensorrt_url_linux": f"{lean_url}/{version}/py38-trt8-cuda10.2-cudnn8/tensorrt.so",
                "binary_url_windows": None,
                "tensorrt_url_windows": None
            },
            {
                ...
                "python": "3.9",
                "lean": "trt8cuda102cudnn8",
                "binary_url_linux": f"{lean_url}/{version}/py39-trt8-cuda10.2-cudnn8/libtrtpyc.so",
                "tensorrt_url_linux": f"{lean_url}/{version}/py39-trt8-cuda10.2-cudnn8/tensorrt.so",
                "binary_url_windows": None,
                "tensorrt_url_windows": None
            }
        ]
    },
    {
        ...
        "binary_url_linux": f"{lean_url}/nvbin/v1.0/trt8cuda112cudnn8.zip",
        "binary_url_windows": None,
        "pycs": [
            {
                ...
                "binary_url_linux": f"{lean_url}/{version}/py37-trt8-cuda11.2-cudnn8/libtrtpyc.so",
                "tensorrt_url_linux": f"{lean_url}/{version}/py37-trt8-cuda11.2-cudnn8/tensorrt.so",
                "binary_url_windows": None,
                "tensorrt_url_windows": None
            },
            {
                ...
                "python": "3.8",
                "lean": "trt8cuda112cudnn8",
                "binary_url_linux": f"{lean_url}/{version}/py38-trt8-cuda11.2-cudnn8/libtrtpyc.so",
                "tensorrt_url_linux": f"{lean_url}/{version}/py38-trt8-cuda11.2-cudnn8/tensorrt.so",
                "binary_url_windows": None,
                "tensorrt_url_windows": None
            },
            {
                ...
                "python": "3.9",
                "lean": "trt8cuda112cudnn8",
                "binary_url_linux": f"{lean_url}/{version}/py39-trt8-cuda11.2-cudnn8/libtrtpyc.so",
                "tensorrt_url_linux": f"{lean_url}/{version}/py39-trt8-cuda11.2-cudnn8/tensorrt.so",
                "binary_url_windows": None,
                "tensorrt_url_windows": None
            }
        ]
...
def get_already_download_nvbinary():
    ...
    for pyc in supported_pycs:
        nvbinary_root = os.path.join(current_root, pyc["lean"], "lean")

        if os.path.isdir(nvbinary_root) and len(os.listdir(nvbinary_root)) > 0:
...
def __load_symbols(pyc_meta):
    ...
    trtexec_path = os.path.join(nvbinary_root, "trtexec")
    current_lean = {}
    ...
    module_variables["nvbinary_root"] = nvbinary_root
    ...
    if os_name == "windows":
        ...
        binary_url_name = "binary_url_windows"
        tensorrt_url_name = "tensorrt_url_windows"
    elif os_name == "linux":
        pyc_module_name = "libtrtpyc"
        pyc_file_name = f"{pyc_module_name}.so"
        trt_file_name = "tensorrt.so"
        binary_url_name = "binary_url_linux"
        tensorrt_url_name = "tensorrt_url_linux"
    else:
    ...
    trt_full_path = os.path.join(current_root, select_nvbinary_version, python_version_module_name, trt_file_name)
    ...
    tensorrt_url = pyc_meta[tensorrt_url_name]
    if tensorrt_url is not None and not os.path.exists(trt_full_path):
        from . import downloader
...
def init(cuda_version : str=None, tensorrt_version : str=None):
    '''
    ...
    if cuda_version is None and tensorrt_version is None:
        ...
        __load_symbols(supported_pycs[0])
        return
