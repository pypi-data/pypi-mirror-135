...
class Buttons:
    ...
    def __init__(self, win, scrwidth, scrheight, index, anzahl, inhalt, abstand=40,
                 ...
                 umrandungs_dicke=0, font_size_height_rel=0.6, x=None, y=None, time_delta=0.2):
        ...
        self.last_click = datetime.datetime.now() - self.time_delta
    ...
    def get_if_clicked(self, mouse=None, mouse_event=None):
        ...
        if hover and mouse_event:
            if datetime.datetime.now()-self.last_click > self.time_delta:
    ...
    def get_mouse_collision(self, maus, ignore_disabled=False):
        ...
        if not self.is_disabled or ignore_disabled:
            ...
            if collisionen.point_square(maus, (self.x, self.y), (self.width, self.height))\
                    or collisionen.point_square(maus, (self.x + self.verschiebung_hintergrund, self.y + self.verschiebung_hintergrund), (self.width, self.height)) and not self.nur_schrift:
                self.is_active = True
                return True
            else:
