...
# Library libs
import fb_redisdb_storage_plugin
from fb_redisdb_storage_plugin.bootstrap import register_services
from fb_redisdb_storage_plugin.manager import StorageManagerFactory
from fb_redisdb_storage_plugin.repository import StorageRepositoryFactory
from fb_redisdb_storage_plugin.state import StorageItem
...
class TestStorageCreatingWithTime(unittest.TestCase):
    ...
    def test_create_record(self, manager_factory: StorageManagerFactory):
        ...
        with patch.object(redis.Redis, "get") as mock_redis_get:
            with patch.object(redis.Redis, "set") as mock_redis_set:
                with patch.object(fb_redisdb_storage_plugin.manager, "datetime") as mock_dt:
