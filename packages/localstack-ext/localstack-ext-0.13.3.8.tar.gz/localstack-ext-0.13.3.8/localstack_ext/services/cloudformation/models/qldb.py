...
class QLDBLedger(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=gbGrq,**kwargs):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return result
 @gbGrp
 def add_defaults(resource:Dict,stack_name:gbGrC):
 ...
 def get_deploy_templates():
  def _delete_ledger(resource_id,resources,*args,**kwargs):
   ...
   qldb.update_ledger(Name=ledger_name,DeletionProtection=gbGre)
