...
class CPVCSMergeManager(SubtypesInstanceManager):
 @VhRyX
 def _is_special_case(obj)->VhRyK:
  return VhRyc(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:VhRyF,to_state_files):
  raise VhRyA("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:VhRyF,from_state_files:VhRyF,to_state_files:VhRyF):
  raise VhRyA("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:VhRyF)->Dict[VhRyF,VhRyF]:
