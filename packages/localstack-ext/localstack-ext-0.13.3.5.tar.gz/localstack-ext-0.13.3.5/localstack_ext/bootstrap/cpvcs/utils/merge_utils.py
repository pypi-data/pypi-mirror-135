...
class CPVCSMergeManager(SubtypesInstanceManager):
 @WwyfH
 def _is_special_case(obj)->Wwyfi:
  return WwyfO(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:Wwyfb,to_state_files):
  raise WwyfD("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:Wwyfb,from_state_files:Wwyfb,to_state_files:Wwyfb):
  raise WwyfD("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:Wwyfb)->Dict[Wwyfb,Wwyfb]:
