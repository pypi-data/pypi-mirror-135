...
from .. import *
from ...exceptions import DRSDownloadException
...
class TestClientLibraryFilesCommand(unittest.TestCase):
    ...
    def test_drs_load(self):
        ...
        except DRSDownloadException as e:
            if 'Optional package not installed: pandas' in e.errors[0].msg:
                self.skipTest('Pandas is not available and it is expected that this test will not be applicable.')
            else:
