...
class PrepareFeaturesTest(PySparkTestCase):
    def setUp(self) -> None:
    ...
    def test_more_complicated(self):
        ...
        expected_features_data = self.spark.createDataFrame(
            [
                ...
                ["1", dt.date(2020, 1, 3), hashlib.md5("f3".encode()).hexdigest(), None, None, "c1f3"],
                ["3", dt.date(2020, 1, 3), hashlib.md5("f3".encode()).hexdigest(), None, None, "c3f3"],
            ],
            [self.__entity.id_column, self.__entity.time_column, "features_hash", "f1", "f2", "f3"],
        )
