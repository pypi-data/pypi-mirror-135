...
class FeatureStore:
    ...
    def get_for_target(
        ...
        rainbow_table = self.__rainbow_table_manager.read(entity)
        targets = self.__targets_filtering_manager.get_targets(target_store, target, target_date_from, target_date_to)
    ...
    def get_targets(
        ...
        return self.__targets_filtering_manager.get_targets(target_store, target, date_from, date_to)
