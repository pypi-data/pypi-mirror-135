...
class Bucket(object):
    ...
    def set_bucket_crr(self, targetBucket, deleteMarkerStatus=None, prefix=None, headers=None):
        replicate = BucketCrossReplicate(targetBucket, deleteMarkerStatus, prefix)
        if headers is None:
            headers = {}
        headers['Content-Type'] = 'text/xml'
