...
def get_size(value_or_type: Union[type, IntTypes]) -> int:
    ...
    :param value_or_type: A type or a value.
    :return:
    """
...
def values2bytearray(
    ...
    parameter `nbits`, otherwise it will use the default value 32.

    If the type of value in the list is numpy int, the data size will base
