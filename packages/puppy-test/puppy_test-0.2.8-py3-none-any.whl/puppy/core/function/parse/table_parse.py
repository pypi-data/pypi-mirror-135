...
class TableParse(object):
    ...
    def __init__(self, table):
        ...
        if type(table) not in [list, tuple]:
            raise Exception("不是受支持的表格数据:{}".format(str(table)))
        self.__table = table
