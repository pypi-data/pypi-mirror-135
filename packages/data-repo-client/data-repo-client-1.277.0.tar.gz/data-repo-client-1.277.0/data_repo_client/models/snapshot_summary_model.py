...
class SnapshotSummaryModel(object):
    ...
    def __init__(self, id=None, name=None, description=None, created_date=None, profile_id=None, storage=None, secure_monitoring_enabled=False, local_vars_configuration=None):  # noqa: E501
