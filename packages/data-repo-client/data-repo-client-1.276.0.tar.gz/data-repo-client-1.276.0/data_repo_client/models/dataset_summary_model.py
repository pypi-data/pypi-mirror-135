...
class DatasetSummaryModel(object):
    ...
    def __init__(self, id=None, name=None, description=None, default_profile_id=None, created_date=None, storage=None, secure_monitoring_enabled=False, local_vars_configuration=None):  # noqa: E501
