...
doc_requires = get_distribution("dkist_processing_core").requires(extras=("docs",))
...
# -- Non stdlib imports --------------------------------------------------------
import dkist_processing_core  # NOQA
from dkist_processing_core import __version__  # NOQA
...
autoapi_dirs = ["../dkist_processing_core"]
