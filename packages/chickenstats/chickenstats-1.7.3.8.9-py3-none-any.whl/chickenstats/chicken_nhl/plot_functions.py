        ...
        for team in teams:
            ...
            if team == good_team:
                ...
                legend = ax.legend(loc="lower center", ncol=3, title = f'{team}', fontsize = 14,
                                    ...
                                    edgecolor = 'gray', handles = all_handles).set_zorder(-1)
                ...
                #    handle._sizes = [250]
                        ...
                        #handle._legmarker.set_markersize(250)


                ax.legend(handler_map={type(): HandlerPathCollection(update_func=update_prop)})
