    ...
    for strength in strengths:
        ...
        for team in teams:
            ...
            if team == good_team:
                ...
                legend_elements = [Line2D([0], [0], color = colors[team]['SHOT'], marker = 'o',
                                    markerfacecolor = colors[team]['GOAL'], label = 'GOAL', markersize = 14),
                                    
                                    Line2D([0], [0], marker='o', color = colors[team]['SHOT'], label= 'SHOT',
                                        markerfacecolor = colors[team]['SHOT'], markersize = 14),

                                   Line2D([0], [0], marker='o', color = colors[team]['MISS'], label= 'MISS',
                                    markerfacecolor = colors[team]['MISS'], markersize = 14)]
