    ...
    for strength in strengths:
        ...
        for team in teams:
            ...
            if team == good_team:
                ...
                legend_elements = [Line2D([0], [0], color = colors_dict['SHOT'], marker = 'o',
                                    markerfacecolor = colors[team]['GOAL'], label = 'GOAL', markersize = 45),
                                    
                                    Line2D([0], [0], marker='o', color = colors_dict['SHOT'], label= 'SHOT',
                                        markerfacecolor = colors[team]['SHOT'], markersize = 16),

                                   Line2D([0], [0], marker='o', color = colors_dict['MISS'], label= 'MISS',
                                    markerfacecolor = colors[team]['MISS'], markersize = 16)]
            ...
            if team == bad_team:
                ...
                legend_elements = [Line2D([0], [0], color = colors_dict['SHOT'], marker = 'o',
                                    ...
                                    Line2D([0], [0], marker='o', color = colors_dict['SHOT'], label= 'SHOT',
                                        markerfacecolor = colors[team]['SHOT'], markersize = 45),

                                   Line2D([0], [0], marker='o', color = colors_dict['MISS'], label= 'MISS',
                                    markerfacecolor = colors[team]['MISS'], markersize = 45)]
