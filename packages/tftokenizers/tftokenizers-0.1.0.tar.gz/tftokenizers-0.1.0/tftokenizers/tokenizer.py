...
from tf_transformers.detect import detect_and_load_tokenizer
from tf_transformers.file import get_vocab_from_path, load_json
from tf_transformers.types import (
    PROCESSING_STEP,
...
from tf_transformers.utils import (
    list_to_tensor,
...
class TFAutoTokenizer(tf.Module):
    ...
    def post_process(self, bs: tf.RaggedTensor) -> tf.RaggedTensor:
        ...
        An example template parsing instruction for BERT could look like:
            ...
            >>> from tf_transformers.load import load_json
