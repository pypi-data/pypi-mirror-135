...
@click.option('--profile-name', required=False, help='Name of the profile to use.', autocompletion=get_profiles)
@click.option('--stdout', required=False, default=False, type=bool, help='Print console url to stdout.')
