...
print("Drivers loaded. You can use fermy.driverslabtool.pump \
or fermy.driverslabtool.scale to access to it.")
from . import driver_balance_sartorius_entris as scale
from . import driver_labjack_pompe_watson_marlow_120u as pump
