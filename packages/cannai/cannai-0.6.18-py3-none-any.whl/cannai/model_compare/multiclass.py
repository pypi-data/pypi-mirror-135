...
def multiclass_f_importance(C_mod, key_list, bar_type = None, show_range="top20",target_label=None,addtional_model=True):
    ...
    for tl1 in target_label:
        ...
        if bar_type == None:
            ...
            def print_fi(iii, par_name,iii_count2, gfii=None):
                ...
                print("iii_c",iii_count2)

                if output_stat == 1:
                    iii_count2 = print_fi2(gfii, ml_name,iii_count2,special_label)
                elif output_stat == 2:
                    iii_count2 = print_fi(None, ml_name,iii_count2,gfii)
                return iii_count2

            def print_fi2(gfii, graph_name,iii_count3,special_label=None):
