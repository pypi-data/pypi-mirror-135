...
print("***** If you have any issues make sure you have created an assets folder containing 'track.png' (draw track blue and background white), 'car.png' and 'red_car.png' *****")
...
track_scale = (1600, 900)

draw_radar = True

track_x, track_y = 0, 0

img_name = "assets/track.png"

output_name = "assets/track_transparent.png"
...
def convert(track="assets/track.png"):
    try:
...
purple_car = pygame.image.load(os.path.join("assets/car.png"))
purple_car = pygame.transform.scale(purple_car, (30, 60))
red_car = pygame.image.load(os.path.join("assets/red-car.png"))
red_car = pygame.transform.scale(red_car, (30, 60))
