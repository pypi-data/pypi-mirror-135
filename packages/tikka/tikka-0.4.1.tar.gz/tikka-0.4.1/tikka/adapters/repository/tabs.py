...
from tikka.domains.entities.tab import TABLE_NAME, Tab
from tikka.domains.interfaces.repository.tabs import TabRepositoryInterface


class Sqlite3TabRepository(TabRepositoryInterface):
    """
