...
class AidlabSDK:
    ...
    def setup_user_callback(self):
        ...
        self.lib.initUserServiceCallback(
            ...
            self.pressure_wear_state_c_callback, self.body_position_c_callback, self.aidlab_sdk_ptr)
    ...
    def setup_synchronization_callback(self):
        ...
        self.lib.initSynchronizationCallback(
            ...
            self.past_body_position_c_callback, self.past_hrv_c_callback, self.aidlab_sdk_ptr)
