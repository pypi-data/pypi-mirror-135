...
class bzCrt:  # 工单处理
    ...
    def __init__(self, system_info, oltInfo, soft_ware_info):
        ...
        self.soft_ware_info = soft_ware_info
    ...
    def getPon_loid_hw(self, loid_info):
        ...
        print_data = [
            {"text": "获取pon信息:", "color": "33", "end": ""},
            {"text": loid_info["desc"], "color": "32"},
        ]
        self.print_log(print_data, "INFO")
    ...
    def generate_script_hw(self, doCrt_info):
        ...
        ord_input.setdefault("Failure_config", {"is_break": False})
    ...
    def doCrt_hw(self, doCrt_info):
        ...
        ord_input.setdefault("Failure_config", {"is_break": False, "break_filters": []})
        Failure_config = ord_input["Failure_config"]
