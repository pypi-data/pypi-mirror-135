...
class GithubLinkGenerator:
    ...
    def __is_daipe_module(self, stack_trace: traceback.FrameSummary) -> bool:
        ...
        return stack_trace.filename.contains("site-packages")
    ...
    def generate_link_from_traceback(self, traceback) -> str:
        last_stack_trace = traceback.extract_tb(traceback)[-1]
