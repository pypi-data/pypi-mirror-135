...
@LastEditTime: 2022-01-24 14:42:40
...
class LoginHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if invoke_result_data.data["user_nick_encrypt"]:
            invoke_result_data.data["user_nick"] = self.emoji_base64_to_emoji(CryptographyHelper.base64_decrypt(invoke_result_data.data["user_nick_encrypt"]))
        ref_params = {}
