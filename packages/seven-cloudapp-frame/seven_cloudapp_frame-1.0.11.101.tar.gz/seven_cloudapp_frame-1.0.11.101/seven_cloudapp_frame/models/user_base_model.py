...
@LastEditTime: 2022-01-24 11:17:45
    ...
    def save_user_by_openid(self, app_id, act_id, open_id, user_nick, avatar, union_id=""):
        ...
        try:
            ...
            if not user_account:
                ...
                user_account.user_nick_encrypt = CryptographyHelper.base64_encrypt(user_account.user_nick) if user_account.user_nick else ""
            ...
            if not user_info:
                ...
                user_info.user_nick_encrypt = CryptographyHelper.base64_encrypt(user_info.user_nick) if user_info.user_nick else ""
    ...
    def update_user_info(self, app_id, act_id, user_id, open_id, user_nick, avatar,is_member_before=-1,is_favor_before=-1):
        ...
        try:
            ...
            if not user_info_dict:
                ...
                user_info_dict["user_nick_encrypt"] = CryptographyHelper.base64_encrypt(user_info_dict["user_nick"]) if user_info_dict["user_nick"] else ""
