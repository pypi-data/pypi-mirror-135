...
setup(
  ...
  package_dir={'public_data_food_analysis': 'public_data_food_analysis'},
  package_data={'public_data_food_analysis': ['data/correction_dic.pickle', 'data/parser_keys.csv']},
  ...
  download_url = 'https://github.com/QiwenZz/public_data_food_analysis/archive/refs/tags/0.0.2.tar.gz',    # I explain this later on
