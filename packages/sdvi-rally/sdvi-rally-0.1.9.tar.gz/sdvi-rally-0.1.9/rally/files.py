...
class RallyFile:
    ...
    def presigned_url(self, timeout=None):
        ...
        :param timeout: custom timeout using positive integers
        :type timeout: int, optional
        
        Usage:

        >>> file = next(get_inventory('Yeti'))
...
def read_file(url, timeout=None):
    ...
    >>> read_file('rsl://location/file2.txt', timeout=7200)
    b'some more text'
    ...
    >>> json.loads(read_file('rsl://MyMetadataStorage/metadata.json', timeout=7200)
    {'a': 'x', 'b': 'y', 'c': 'z'}
...
def read_files(*urls, timeout=None):
    ...
    >>> for f in read_files('rsl://location/file.txt', 'rsl://location/file2.txt', timeout=7200):
    ...     print(f)
    b'some text'
    b'more text'

    >>> for f in read_files('rsl://location/file3.txt', 'rsl://location/file4.txt'):
    ...     print(f)
    b'other text'
    b'even more text'
