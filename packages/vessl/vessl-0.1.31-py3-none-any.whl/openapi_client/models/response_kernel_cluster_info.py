...
class ResponseKernelClusterInfo(object):
    ...
    def __init__(self, available_gpus=None, config=None, created_dt=None, current_system_metrics=None, docs_link=None, id=None, is_cluster_admin=None, is_registered=None, is_savvihub_managed=None, kubernetes_ingress_endpoint=None, kubernetes_namespace=None, kubernetes_service_type=None, message=None, name=None, provider=None, region=None, status=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
