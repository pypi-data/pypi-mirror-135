...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="Run data warehouse validations after model is successfully committed",
)
@pass_config
@click.pass_context
@exception_handler
def commit_configs(
    ...
    dw_validations: Optional[bool] = False,
) -> None:
    ...
    if dw_validations:
        spinner_dw = Halo(text="Validating commited model against data warehouse", spinner="dots")
        spinner_dw.start()
