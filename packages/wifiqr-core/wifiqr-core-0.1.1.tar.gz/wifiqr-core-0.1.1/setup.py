...
MINIMAL_DESCRIPTION = """WiFiQR-Core Generate a QR code to share WiFi creds (SSID+Pass). This is the core functionality can be used as library, API or a CLI tools. It's used by the WiFiQR WebApp."""
