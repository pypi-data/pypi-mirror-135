...
def streaming_copy(api, project, path, media_id=None, filename=None, chunk_size=1024*1024*10,
                   file_size=None):
    """ Uploads a file from a remote URL without downloading entire file.
