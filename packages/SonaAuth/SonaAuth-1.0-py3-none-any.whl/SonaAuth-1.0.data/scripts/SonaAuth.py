...
class api:
    ...
    def SonaAuthRegisterResponse(self, user, password, license, hwid=None):
        if hwid is None:
    ...
    def SonaAuthLoginResponse(self, user, password, hwid=None):
        if hwid is None:
            hwid = others.get_hwid()
    ...
    def SonaAuthLicense(self, key, hwid=None):
        if hwid is None:
            hwid = others.get_hwid()
    ...
    def __do_request(self, post_data):
        ...
        rq_out = requests.post(
            "https://sonafreelance.xyz/api/1.0/", data=post_data
        )
